    ...
    rootValue: {
      ...
      createEmployee: (args) => {
        const employee = new Employee({
          ...
          dateOfJoining: new Date(args.employeeInput.dateOfJoining),
...
mongoose
  .connect(
    `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0.luk8i.mongodb.net/${process.env.MONGO_DB}?retryWrites=true&w=majority`
  )
  .then(() => {
